...
public class Main {
	 ...
	 */
	public final static int peersNum = 100;
	/**
	 * Type of P2P network.
	 */
	public final static P2pType p2pType = P2pType.FAIRE9BUTTERFLY;
	/**
	 * Maximum number of known peers each peer can aquire.
	 */
	public final static int knownPeersMax = 500;
	/**
	 ...
	 */
	public final static int requestTtl = 10;
	/**
	...
	public Main() {
		...
		crowd = new Crowd(initialSourceUpSlotsNum);
		crowd.addPeers(peersNum - 1, downSlotsNum, upSlotsNum, downPendingMax,
		...
		System.out.println(String.format(
				...
				rounds, latency, crowd.getLatencyStdev(latency), crowd
						.getUploadsStdev(), crowd.getUploadsMax(), crowd
						.getUploadsDistinctPiecesAverage(), p2pType.name(),
				peersNum, piecesNum, downSlotsNum, upSlotsNum, downPendingMax,
